...
- $\alpha_i$ = l'angolo tra $z_i$ e $z_{i-1}$, lungo l'asse $x_i$
- $\theta_i$ = l'angolo tra $x_i$ e $x_{i-1}$, lungo l'asse $z_i$ 
- $d_i$ = la distanza tra $x_i$ e $x_{i-1}$, lungo l'asse z
- $a_i$ = la distanza tra $z_i$ e $z_{i-1}$, lungo l'asse x
